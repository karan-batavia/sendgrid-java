...
``` bash
javac -classpath ../repo/com/sendgrid/5.0.0-rc.8/sendgrid-5.0.0-rc.8-jar.jar:. Example.java && java -classpath ../repo/com/sendgrid/5.0.0-rc.8/sendgrid-5.0.0-rc.8-jar.jar:. Example
```
